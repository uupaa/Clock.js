...
//{@dev
    ...
    $valid($keys(options, "start|vsync|speed|pulse|suspend|baseTime"), Clock, "options");
    if (options) {
...
Clock["prototype"] = {
    "constructor":  Clock,              // new Clock(ticks:TickFunctionArray = [], options:Object = {}):Clock
    // --- base time ---
    "setBaseTime":  Clock_setBaseTime,  // Clock.setBaseTime(baseTime:Number):void
    "getBaseTime":  Clock_getBaseTime,  // Clock.getBaseTime():Number
    "now":          Clock_now,          // Clock.now():Number
    // --- clock state ---
    "start":        Clock_start,        // Clock#start():this
    "pause":        Clock_pause,        // Clock#pause():this
    "stop":         Clock_stop,         // Clock#stop():this
    "isActive":     Clock_isActive,     // Clock#isActive():Boolean
    // --- register / unregister callback functions ---
    "on":           Clock_on,           // Clock#on(tick:Function):this
    "off":          Clock_off,          // Clock#off(tick:Function):this
    "has":          Clock_has,          // Clock#has(tick:Function):Boolean
    "clear":        Clock_clear,        // Clock#clear():this
    // --- register temporary callback function ---
    "nth":          Clock_nth,          // Clock#nth(callback:Function, times:Integer = 1):this
    // --- utility ---
    "resetCount":   Clock_resetCount,   // Clock#resetCount():this
    "resetTimeStamp":Clock_resetTimeStamp // Clock#resetTimeStamp():this
};
